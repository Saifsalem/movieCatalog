...
public class ModernProjectManagementController implements Initializable {
	...
	@FXML
	private Button supplierManagementBtn;
	@FXML
	private Button materialManagementBtn;
	@FXML
	private Button branchManagementBtn;
	@FXML
	private Button roleManagementBtn;
	@FXML
	private Button departmentManagementBtn;
	@FXML
	private Button phaseManagementBtn;
	@FXML
	private Button paymentManagementBtn;

	// Views
	@FXML
	private VBox dashboardView;
	@FXML
	private VBox employeeManagementView;
	@FXML
	private VBox projectManagementView;
	@FXML
	private VBox clientManagementView;
	@FXML
	private VBox supplierManagementView;
	@FXML
	private VBox materialManagementView;
	@FXML
	private VBox branchManagementView;
	@FXML
	private VBox roleManagementView;
	@FXML
	private VBox departmentManagementView;
	@FXML
	private VBox phaseManagementView;
	@FXML
	private VBox paymentManagementView;
	@FXML
	...
	@FXML
	private ComboBox<Role> positionComboBox;
	@FXML
	private TextField salaryField;
	@FXML
	private ComboBox<Branch> empBranchComboBox;
	@FXML
	private ComboBox<Department> empDepartmentComboBox;
	@FXML
	...
	@FXML
	private TableColumn<Employee, String> empBranchColumn;
	@FXML
	private TableColumn<Employee, String> empDepartmentColumn;
	@FXML
	private TableColumn<Employee, String> empManagerColumn;
	@FXML
	...
	@FXML
	private ComboBox<Branch> projectBranchComboBox;
	@FXML
	private ComboBox<Client> projectClientComboBox;
	@FXML
	...
	@FXML
	private TableColumn<Project, Double> projectCostColumn;
	@FXML
	private TableColumn<Project, Double> projectRevenueColumn;
	@FXML
	private TableColumn<Project, String> projectBranchColumn;
	@FXML
	private Button addProjectBtn;
	@FXML
	private Button saveProjectBtn;
	@FXML
	private Button updateProjectBtn;
	@FXML
	...
	@FXML
	private TextField materialPriceField;
	@FXML
	...
	@FXML
	private TableColumn<Material, Double> materialPriceColumn;
	@FXML
	...
	@FXML
	private Button refreshMaterialsBtn;
	...
	@FXML
	private Button refreshRolesBtn;
	...
	@FXML
	private Button saveDepartmentBtn;
	@FXML
	private Button updateDepartmentBtn;
	@FXML
	private Button deleteDepartmentBtn;
	@FXML
	private Button refreshDepartmentsBtn;

	// Phase Management
	@FXML
	private TextField phaseIdField;
	@FXML
	private ComboBox<Project> phaseProjectComboBox;
	@FXML
	private TextField phaseNameField;
	@FXML
	private TextArea phaseDescriptionField;
	@FXML
	private DatePicker phaseStartDatePicker;
	@FXML
	private DatePicker phaseEndDatePicker;
	@FXML
	private ComboBox<String> phaseStatusComboBox;
	@FXML
	private TableView<Phase> phaseTable;
	@FXML
	private TableColumn<Phase, Integer> phaseIdColumn;
	@FXML
	private TableColumn<Phase, String> phaseProjectColumn;
	@FXML
	private TableColumn<Phase, String> phaseNameColumn;
	@FXML
	private TableColumn<Phase, Date> phaseStartDateColumn;
	@FXML
	private TableColumn<Phase, Date> phaseEndDateColumn;
	@FXML
	private TableColumn<Phase, String> phaseStatusColumn;
	@FXML
	private Button addPhaseBtn;
	@FXML
	private Button savePhaseBtn;
	@FXML
	private Button updatePhaseBtn;
	@FXML
	private Button deletePhaseBtn;
	@FXML
	private Button refreshPhasesBtn;

	// Payment Management
	@FXML
	private TextField paymentIdField;
	@FXML
	private ComboBox<Client> paymentClientComboBox;
	@FXML
	private ComboBox<Supplier> paymentSupplierComboBox;
	@FXML
	...
	@FXML
	private TableColumn<Payment, String> paymentClientColumn;
	@FXML
	private TableColumn<Payment, String> paymentSupplierColumn;
	@FXML
	...
	@FXML
	private Button refreshPaymentsBtn;
	...
	@FXML
	private Button generateProfitabilityReportBtn;
	@FXML
	private Button generateWorkloadReportBtn;
	@FXML
	private Button generateMaterialReportBtn;
	@FXML
	private Button generateBranchReportBtn;
	@FXML
	private Button generateSupplierReportBtn;
	@FXML
	private Button generateTimelineReportBtn;
	...
	private void setupPaymentTable() {
		...
		paymentSupplierColumn.setCellValueFactory(cellData -> {
			...
			return new javafx.beans.property.SimpleStringProperty(
					supplier != null ? supplier.getSuppName() : "Unknown");
		});
	...
	private void setupPhaseComboBoxes() {
		...
		phaseStatusComboBox.setItems(
				FXCollections.observableArrayList("Planning", "In Progress", "Completed", "On Hold", "Cancelled"));
	}
	...
	private void setupPaymentComboBoxes() {
		...
		paymentMethodComboBox.setItems(
				FXCollections.observableArrayList("Cash", "Credit Card", "Bank Transfer", "Check", "Online Payment"));
	}
...
// Dashboard Statistics Update
	private void updateDashboardStats() {
		try {
			...
			double totalRevenue = projectDAO.getAllProjects().stream().mapToDouble(Project::getRevenue).sum();
...
// Field Population Methods
	private void populateEmployeeFields(Employee employee) {
		...
		positionComboBox.getItems().stream().filter(role -> role.getRoleId() == employee.getPositionId()).findFirst()
				.ifPresent(positionComboBox::setValue);

		empBranchComboBox.getItems().stream().filter(branch -> branch.getBranchId() == employee.getBranchId())
				.findFirst().ifPresent(empBranchComboBox::setValue);

		empDepartmentComboBox.getItems().stream().filter(dept -> dept.getDeptId() == employee.getDepartmentId())
				.findFirst().ifPresent(empDepartmentComboBox::setValue);

		if (employee.getManagerId() != null) {
			managerComboBox.getItems().stream().filter(manager -> manager.getEmpId() == employee.getManagerId())
					.findFirst().ifPresent(managerComboBox::setValue);
		} else {
	...
	private void populateProjectFields(Project project) {
		...
		// Set ComboBox selections
		projectBranchComboBox.getItems().stream().filter(branch -> branch.getBranchId() == project.getBranchId())
				.findFirst().ifPresent(projectBranchComboBox::setValue);

		projectClientComboBox.getItems().stream().filter(client -> client.getClientId() == project.getClientId())
				.findFirst().ifPresent(projectClientComboBox::setValue);
	}
...
private void populatePhaseimport javafx.animation.Animation
;
import javafx.animation.KeyFrame;
import javafx.animation.Timeline;
import javafx.collections.FXCollections;
