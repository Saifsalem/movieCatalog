...
public class updated_main_dashboard_controller implements Initializable {
    ...
    @FXML private Button manageRolesBtn;
    @FXML private Button manageDepartmentsBtn;
    ...
    private void setupEventHandlers() {
        ...
        manageRolesBtn.setOnAction(e -> openRoleManagement());
        manageDepartmentsBtn.setOnAction(e -> openDepartmentManagement());
    }
    ...
    private void openRoleManagement() {
        openNewWindow("/fxml/RoleManagement.fxml", "Role Management");
    }
    
    private void openDepartmentManagement() {
        openNewWindow("/fxml/DepartmentManagement.fxml", "Department Management");
    }
